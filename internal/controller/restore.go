...
func (r *OpenClawInstanceReconciler) reconcileRestore(ctx context.Context, instance *openclawv1alpha1.OpenClawInstance) (result ctrl.Result, done bool, _ error) {
	...
	if apierrors.IsNotFound(err) || existingJob == nil {
		...
		job := buildRcloneJob(jobName, instance.Namespace, pvcName, instance.Spec.RestoreFrom, labels, creds, false, instance.Spec.Availability.NodeSelector, instance.Spec.Availability.Tolerations, instance.Spec.Backup.ServiceAccountName)
